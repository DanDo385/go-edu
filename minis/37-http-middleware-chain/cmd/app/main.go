...
/*
minis/37-http-middleware-chain: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/37-http-middleware-chain")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: httpmiddlewarechain concepts")
		fmt.Println("See internal/httpmiddlewarechain/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/httpmiddlewarechain/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/httpmiddlewarechain/exercise.go for implementation")
}
