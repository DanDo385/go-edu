...
Understanding Go's interface system and duck typing
...
2. Open the exercise file:
   ```bash
   code internal/interfacesducktyping/exercise.go
   ```
...
If you get stuck, check `internal/interfacesducktyping/solution.reference.go` for a complete
