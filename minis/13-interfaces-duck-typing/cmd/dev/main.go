...
//
// To use:
// 1. Set breakpoints in ../../internal/exercise/interfacesducktyping.go
...
import (
	...
	"github.com/example/go-10x-minis/minis/13-interfaces-duck-typing/internal/interfacesducktyping"
)

func main() {
	fmt.Println("=== Debugging Interfaces and Duck Typing ===")
	...
	fmt.Println("\nNote: Set breakpoints in internal/exercise/interfacesducktyping.go")
	fmt.Println("to debug interface implementations, type assertions, and duck typing.")
	fmt.Println("\nUse cmd/app/main.go for comprehensive demonstrations with flag package.")
}
