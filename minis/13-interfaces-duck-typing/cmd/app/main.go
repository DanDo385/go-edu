...
/*
minis/13-interfaces-duck-typing: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/13-interfaces-duck-typing")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: interfacesducktyping concepts")
		fmt.Println("See internal/interfacesducktyping/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/interfacesducktyping/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/interfacesducktyping/exercise.go for implementation")
}
