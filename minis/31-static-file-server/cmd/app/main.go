...
/*
minis/31-static-file-server: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/31-static-file-server")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: staticfileserver concepts")
		fmt.Println("See internal/staticfileserver/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/staticfileserver/exercise.go
