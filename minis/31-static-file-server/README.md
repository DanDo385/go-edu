...
Build a production-ready static file server with modern HTTP features
...
2. Open the exercise file:
   ```bash
   code internal/staticfileserver/exercise.go
   ```
...
If you get stuck, check `internal/staticfileserver/solution.reference.go` for a complete
