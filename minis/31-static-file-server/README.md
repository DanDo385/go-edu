# 31-static-file-server: Static File Server

## Overview

Static File Server exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master static file server concepts
...
# Open internal/static/file/server/exercise.go and complete the TODOs
...
See `internal/static/file/server/solution.reference.go` for:
