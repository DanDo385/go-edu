...
Build an HTTP server with routes, middleware, and graceful shutdown
...
2. Open the exercise file:
   ```bash
   code internal/httpservergraceful/exercise.go
   ```
...
If you get stuck, check `internal/httpservergraceful/solution.reference.go` for a complete
