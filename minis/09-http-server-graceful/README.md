...
HTTP Server Graceful Shutdown exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master http server graceful shutdown concepts
...
# Open internal/http/server/graceful/exercise.go and complete the TODOs
...
See `internal/http/server/graceful/solution.reference.go` for:
