...
func main() {
	...
	// Example:
	// import "minis/09-http-server-graceful/internal/httpservergraceful"
	// 
	// input := "example"
	// result := httpservergraceful.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/09-http-server-graceful/internal/httpservergraceful\"")
