...
/*
minis/09-http-server-graceful: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/09-http-server-graceful")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: httpservergraceful concepts")
		fmt.Println("See internal/httpservergraceful/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/httpservergraceful/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/httpservergraceful/exercise.go for implementation")
}
