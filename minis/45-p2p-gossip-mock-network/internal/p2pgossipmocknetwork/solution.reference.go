...
/*
Reference Solution - P2P Gossip Mock Network
============================================

Gossip: nodes broadcast messages to peers; each peer forwards to its peers.
Mock: in-memory network, no real sockets. Node has peers list, Send/Receive.
Broadcast: fan-out to all peers. Simulates blockchain/Ethereum-style P2P.
*/
