# 45-p2p-gossip-mock-network: P2P Gossip Network

## Overview

P2P Gossip Network exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master p2p gossip network concepts
...
# Open internal/p2p/gossip/mock/network/exercise.go and complete the TODOs
...
See `internal/p2p/gossip/mock/network/solution.reference.go` for:
