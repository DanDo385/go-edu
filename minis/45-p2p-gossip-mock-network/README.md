...
2. Open the exercise file:
   ```bash
   code internal/p2pgossipmocknetwork/exercise.go
   ```
...
If you get stuck, check `internal/p2pgossipmocknetwork/solution.reference.go` for a complete
