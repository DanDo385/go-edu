...
Understanding Go's pointer semantics and nil handling
...
2. Open the exercise file:
   ```bash
   code internal/pointerszerovaluesnilgotchas/exercise.go
   ```
...
If you get stuck, check `internal/pointerszerovaluesnilgotchas/solution.reference.go` for a complete
