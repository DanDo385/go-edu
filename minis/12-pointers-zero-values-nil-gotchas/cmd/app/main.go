...
/*
12-pointers-zero-values-nil-gotchas CLI Application
...
Quick start:
  1. Implement functions in internal/pointerszerovaluesnilgotchas/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 12-pointers-zero-values-nil-gotchas ===")
	fmt.Println()
