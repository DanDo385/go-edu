...
/*
minis/12-pointers-zero-values-nil-gotchas: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/12-pointers-zero-values-nil-gotchas")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: pointerszerovaluesnilgotchas concepts")
		fmt.Println("See internal/pointerszerovaluesnilgotchas/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/pointerszerovaluesnilgotchas/exercise.go
