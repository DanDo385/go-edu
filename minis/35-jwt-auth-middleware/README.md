...
JWT Authentication exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master jwt authentication concepts
...
# Open internal/jwt/auth/middleware/exercise.go and complete the TODOs
...
See `internal/jwt/auth/middleware/solution.reference.go` for:
