...
/*
minis/35-jwt-auth-middleware: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/35-jwt-auth-middleware")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: jwtauthmiddleware concepts")
		fmt.Println("See internal/jwtauthmiddleware/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/jwtauthmiddleware/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/jwtauthmiddleware/exercise.go for implementation")
}
