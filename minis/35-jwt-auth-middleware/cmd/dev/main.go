...
//
// To use:
// 1. Set breakpoints in ../../internal/jwtauthmiddleware/exercise.go
...
func main() {
	fmt.Println("=== Debugging 35-jwt-auth-middleware ===")
	fmt.Println()
	
	// TODO: Add your debugging code here
	// Example: Call functions from the jwtauthmiddleware package
