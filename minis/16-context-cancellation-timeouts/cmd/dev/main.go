...
//
// To use:
// 1. Set breakpoints in ../../internal/exercise/contextcancellationtimeouts.go
...
import (
	...
	"github.com/example/go-10x-minis/minis/16-context-cancellation-timeouts/internal/contextcancellationtimeouts"
)
...
func main() {
	...
	// Set breakpoint in contextcancellationtimeouts.go at FetchAll function
	results, err := contextcancellationtimeouts.FetchAll(ctx, urls, 1*time.Second)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
		return
	}
