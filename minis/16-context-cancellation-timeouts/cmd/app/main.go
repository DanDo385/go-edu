...
/*
16-context-cancellation-timeouts CLI Application
...
Quick start:
  1. Implement functions in internal/contextcancellationtimeouts/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 16-context-cancellation-timeouts ===")
	fmt.Println()
