# 16-context-cancellation-timeouts: Context and Timeouts

## Overview

Context and Timeouts exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master context and timeouts concepts
...
# Open internal/context/cancellation/timeouts/exercise.go and complete the TODOs
...
See `internal/context/cancellation/timeouts/solution.reference.go` for:
