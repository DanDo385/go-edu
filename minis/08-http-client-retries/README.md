# 08-http-client-retries: HTTP Client with Retries

## Overview

HTTP Client with Retries exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master http client with retries concepts
...
# Open internal/http/client/retries/exercise.go and complete the TODOs
...
See `internal/http/client/retries/solution.reference.go` for:
