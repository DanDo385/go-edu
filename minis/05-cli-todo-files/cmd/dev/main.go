...
func main() {
	...
	// Example:
	// import "minis/05-cli-todo-files/internal/clitodofiles"
	// 
	// input := "example"
	// result := clitodofiles.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/05-cli-todo-files/internal/clitodofiles\"")
