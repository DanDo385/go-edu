# 05-cli-todo-files: CLI Todo Application

## Overview

CLI Todo Application exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master cli todo application concepts
...
# Open internal/cli/todo/files/exercise.go and complete the TODOs
...
See `internal/cli/todo/files/solution.reference.go` for:
