...
- The concrete problem in Bounded Channel Semaphore and the correctness invariants it depends on.
...
- Diagnose and implement Bounded Channel Semaphore patterns without relying on hidden framework behavior.
...
Problem statement:
This lesson turns the previous module's concepts into a reusable engineering pattern for bounded channel semaphore.

At this point in the arc:
Lesson 23 introduces a sharper systems concern so later modules can assume this mental model is stable.
...
## Related Lessons
- Previous: `minis/22-worker-pool-with-backpressure`
- Next: `minis/24-sync-mutex-vs-rwmutex`
