...
/*
23-bounded-channel-semaphore CLI Application
...
Quick start:
  1. Implement functions in internal/boundedchannelsemaphore/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 23-bounded-channel-semaphore ===")
	fmt.Println()
