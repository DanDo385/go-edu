...
import (
	...
	_ "github.com/example/go-10x-minis/minis/02-arrays-maps-basics/internal/arraysmapsbasics"
)
...
func main() {
	...
	fmt.Println("Running 02-arrays-maps-basics...")
	
	// TODO: Call your internal package function here using the flags
	// Example:
	// arraysmapsbasics.Run(*input)
}
