...
func main() {
	...
	// Example:
	// import "minis/02-arrays-maps-basics/internal/arraysmapsbasics"
	// 
	// input := "example"
	// result := arraysmapsbasics.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/02-arrays-maps-basics/internal/arraysmapsbasics\"")
