# 02-arrays-maps-basics: Arrays, Slices, and Maps

## Overview

Arrays, Slices, and Maps exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master arrays, slices, and maps concepts
...
# Open internal/arrays/maps/basics/exercise.go and complete the TODOs
...
See `internal/arrays/maps/basics/solution.reference.go` for:
