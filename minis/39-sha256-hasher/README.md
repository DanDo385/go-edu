...
Cryptographic Hashing exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master cryptographic hashing concepts
...
# Open internal/sha256/hasher/exercise.go and complete the TODOs
...
See `internal/sha256/hasher/solution.reference.go` for:
