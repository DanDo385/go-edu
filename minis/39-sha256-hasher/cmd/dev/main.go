...
func main() {
	...
	// Example:
	// import "minis/39-sha256-hasher/internal/sha256hasher"
	// 
	// input := "example"
	// result := sha256hasher.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/39-sha256-hasher/internal/sha256hasher\"")
