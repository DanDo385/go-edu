...
func main() {
	...
	// Example:
	// import "minis/21-race-detection-demo/internal/racedetectiondemo"
	// 
	// input := "example"
	// result := racedetectiondemo.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/21-race-detection-demo/internal/racedetectiondemo\"")
