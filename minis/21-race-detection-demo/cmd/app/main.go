...
/*
minis/21-race-detection-demo: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/21-race-detection-demo")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: racedetectiondemo concepts")
		fmt.Println("See internal/racedetectiondemo/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/racedetectiondemo/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/racedetectiondemo/exercise.go for implementation")
}
