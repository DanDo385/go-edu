# 21-race-detection-demo: Race Condition Detection

## Overview

Race Condition Detection exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master race condition detection concepts
...
# Open internal/race/detection/demo/exercise.go and complete the TODOs
...
See `internal/race/detection/demo/solution.reference.go` for:
