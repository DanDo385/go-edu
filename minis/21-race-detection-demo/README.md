...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "NewLazyInitSolution"
go run ./cmd/app -fn "NewMetricsSolution"
go run ./cmd/app -fn "NewSafeCounterMutexSolution"
go run ./cmd/dev
```
...
- `internal/racedetectiondemo/exercise.go`: implement the TODOs here
- `internal/racedetectiondemo/solution.reference.go`: full reference solution (tagged)
