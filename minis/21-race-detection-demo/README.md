...
- The concrete problem in Race Detection Demo and the correctness invariants it depends on.
...
- Diagnose and implement Race Detection Demo patterns without relying on hidden framework behavior.
...
Problem statement:
This lesson turns the previous module's concepts into a reusable engineering pattern for race detection demo.

At this point in the arc:
Lesson 21 introduces a sharper systems concern so later modules can assume this mental model is stable.
...
## Related Lessons
- Previous: `minis/20-select-fanin-fanout`
- Next: `minis/22-worker-pool-with-backpressure`
