...
/*
Reference Solution - Race Detection Demo
========================================

go test -race: detects data races at runtime. Correct solution: protect shared
state with sync.Mutex or channel. Buggy: concurrent read/write without sync.
Demonstrates why mutex/channel discipline matters; -race is essential in CI.
*/
