# minis/25-atomic-counters-vs-mutex
...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "NewAtomicBitmap"
go run ./cmd/app -fn "NewAtomicCounter"
go run ./cmd/app -fn "NewAtomicFlag"
go run ./cmd/dev
```
...
- `internal/atomiccountersvsmutex/exercise.go`: implement the TODOs here
- `internal/atomiccountersvsmutex/solution.reference.go`: full reference solution (tagged)
