...
/*
48-reflection-introspection CLI Application
...
Quick start:
  1. Implement functions in internal/reflectionintrospection/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 48-reflection-introspection ===")
	fmt.Println()
