...
/*
minis/48-reflection-introspection: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/48-reflection-introspection")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: reflectionintrospection concepts")
		fmt.Println("See internal/reflectionintrospection/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/reflectionintrospection/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/reflectionintrospection/exercise.go for implementation")
}
