# minis/48-reflection-introspection
...
- `internal/reflectionintrospection/exercise.go`: implement the TODOs here
- `internal/reflectionintrospection/solution.reference.go`: full reference solution (tagged)
