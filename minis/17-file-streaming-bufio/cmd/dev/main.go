...
//
// To use:
// 1. Set breakpoints in ../../internal/exercise/filestreamingbufio.go
...
import (
	...
	"github.com/example/go-10x-minis/minis/17-file-streaming-bufio/internal/filestreamingbufio"
)
...
line five`
	...
	// Set breakpoint in filestreamingbufio.go at CountLines function
	count, err := filestreamingbufio.CountLines(reader)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
		return
	}
	...
	freq, err := filestreamingbufio.WordFrequency(reader2)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
		return
	}
