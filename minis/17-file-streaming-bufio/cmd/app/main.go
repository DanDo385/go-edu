...
/*
minis/17-file-streaming-bufio: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/17-file-streaming-bufio")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: filestreamingbufio concepts")
		fmt.Println("See internal/filestreamingbufio/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/filestreamingbufio/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/filestreamingbufio/exercise.go for implementation")
}
