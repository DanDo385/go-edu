...
import (
	...
	_ "github.com/example/go-10x-minis/minis/17-file-streaming-bufio/internal/filestreamingbufio"
)
...
func main() {
	...
	fmt.Println("Running 17-file-streaming-bufio...")
	
	// TODO: Call your internal package function here using the flags
	// Example:
	// filestreamingbufio.Run(*input)
}
