...
/*
Reference Solution - Merkle Tree: Build, Verify, Proofs
======================================================

BuildMerkleTree: hash leaves, pair and hash level by level until root.
VerifyMerkleProof: start with leaf hash, combine with siblings (IsLeft order),
compare final hash to root. ProofNode: sibling hash + IsLeft. Used in
blockchain and content-addressable storage for inclusion proofs.
*/
