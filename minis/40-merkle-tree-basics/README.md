...
- `internal/merkletreebasics/exercise.go`: implement the TODOs here
- `internal/merkletreebasics/solution.reference.go`: full reference solution (tagged)
