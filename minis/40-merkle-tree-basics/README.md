# 40-merkle-tree-basics: Merkle Tree Implementation

## Overview

Merkle Tree Implementation exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master merkle tree implementation concepts
...
# Open internal/merkle/tree/basics/exercise.go and complete the TODOs
...
See `internal/merkle/tree/basics/solution.reference.go` for:
