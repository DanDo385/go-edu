...
/*
Reference Solution - Escape Analysis and Inlining
================================================

go build -gcflags='-m' shows what escapes to heap and what gets inlined.
Stack allocation when compiler can prove lifetime; heap when pointer escapes
(returned, stored in global, sent to channel). Value receivers avoid escape
for small structs. strings.Builder over concatenation. Inlining: small
functions inlined; -l flag disables. Inlined code enables further optimizations.
*/
