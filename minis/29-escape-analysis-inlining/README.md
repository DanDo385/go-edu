...
Compiler Optimizations exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master compiler optimizations concepts
...
# Open internal/escape/analysis/inlining/exercise.go and complete the TODOs
...
See `internal/escape/analysis/inlining/solution.reference.go` for:
