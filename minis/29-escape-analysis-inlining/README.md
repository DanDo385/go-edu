...
2. Open the exercise file:
   ```bash
   code internal/escapeanalysisinlining/exercise.go
   ```
...
If you get stuck, check `internal/escapeanalysisinlining/solution.reference.go` for a complete
