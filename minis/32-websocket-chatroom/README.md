...
- `internal/websocketchatroom/exercise.go`: implement the TODOs here
- `internal/websocketchatroom/solution.reference.go`: full reference solution (tagged)
