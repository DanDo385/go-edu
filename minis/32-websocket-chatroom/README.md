# 32-websocket-chatroom: WebSocket Chat Room

## Overview

WebSocket Chat Room exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master websocket chat room concepts
...
# Open internal/websocket/chatroom/exercise.go and complete the TODOs
...
See `internal/websocket/chatroom/solution.reference.go` for:
