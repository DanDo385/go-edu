...
/*
minis/32-websocket-chatroom: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/32-websocket-chatroom")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: websocketchatroom concepts")
		fmt.Println("See internal/websocketchatroom/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/websocketchatroom/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/websocketchatroom/exercise.go for implementation")
}
