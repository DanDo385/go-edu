...
/*
minis/01-hello-strings: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/01-hello-strings")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: hellostrings concepts")
		fmt.Println("See internal/hellostrings/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/hellostrings/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/hellostrings/exercise.go for implementation")
}
