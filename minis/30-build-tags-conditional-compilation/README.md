...
Build Tags exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master build tags concepts
...
# Open internal/build/tags/conditional/compilation/exercise.go and complete the TODOs
...
See `internal/build/tags/conditional/compilation/solution.reference.go` for:
