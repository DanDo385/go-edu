# minis/30-build-tags-conditional-compilation
...
- `internal/buildtagsconditionalcompilation/exercise.go`: implement the TODOs here
- `internal/buildtagsconditionalcompilation/solution.reference.go`: full reference solution (tagged)
