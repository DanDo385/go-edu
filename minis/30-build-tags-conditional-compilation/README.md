...
├── internal/
│   └── buildtagsconditionalcompilation/
...
2. Open the exercise file:
   ```bash
   code internal/buildtagsconditionalcompilation/exercise.go
   ```
...
If you get stuck, check `internal/buildtagsconditionalcompilation/solution.reference.go` for a complete
