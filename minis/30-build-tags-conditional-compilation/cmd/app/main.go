...
/*
30-build-tags-conditional-compilation CLI Application
...
Quick start:
  1. Implement functions in internal/buildtagsconditionalcompilation/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 30-build-tags-conditional-compilation ===")
	fmt.Println()
