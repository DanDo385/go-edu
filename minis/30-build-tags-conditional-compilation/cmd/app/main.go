...
/*
minis/30-build-tags-conditional-compilation: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/30-build-tags-conditional-compilation")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: buildtagsconditionalcompilation concepts")
		fmt.Println("See internal/buildtagsconditionalcompilation/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/buildtagsconditionalcompilation/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/buildtagsconditionalcompilation/exercise.go for implementation")
}
