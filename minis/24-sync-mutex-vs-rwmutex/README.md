...
- The concrete problem in Sync Mutex Vs Rwmutex and the correctness invariants it depends on.
...
- Diagnose and implement Sync Mutex Vs Rwmutex patterns without relying on hidden framework behavior.
...
Problem statement:
This lesson turns the previous module's concepts into a reusable engineering pattern for sync mutex vs rwmutex.

At this point in the arc:
Lesson 24 introduces a sharper systems concern so later modules can assume this mental model is stable.
...
## Related Lessons
- Previous: `minis/23-bounded-channel-semaphore`
- Next: `minis/25-atomic-counters-vs-mutex`
