...
/*
minis/24-sync-mutex-vs-rwmutex: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/24-sync-mutex-vs-rwmutex")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: syncmutexvsrwmutex concepts")
		fmt.Println("See internal/syncmutexvsrwmutex/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/syncmutexvsrwmutex/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/syncmutexvsrwmutex/exercise.go for implementation")
}
