...
func main() {
	...
	// Example:
	// import "minis/24-sync-mutex-vs-rwmutex/internal/syncmutexvsrwmutex"
	// 
	// input := "example"
	// result := syncmutexvsrwmutex.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/24-sync-mutex-vs-rwmutex/internal/syncmutexvsrwmutex\"")
