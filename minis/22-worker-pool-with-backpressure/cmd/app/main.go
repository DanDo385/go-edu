...
/*
minis/22-worker-pool-with-backpressure: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/22-worker-pool-with-backpressure")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: workerpoolwithbackpressure concepts")
		fmt.Println("See internal/workerpoolwithbackpressure/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/workerpoolwithbackpressure/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/workerpoolwithbackpressure/exercise.go for implementation")
}
