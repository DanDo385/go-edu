...
/*
22-worker-pool-with-backpressure CLI Application
...
Quick start:
  1. Implement functions in internal/workerpoolwithbackpressure/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 22-worker-pool-with-backpressure ===")
	fmt.Println()
