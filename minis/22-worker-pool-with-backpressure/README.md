...
Worker pool with backpressure and rate limiting
...
2. Open the exercise file:
   ```bash
   code internal/workerpoolwithbackpressure/exercise.go
   ```
...
If you get stuck, check `internal/workerpoolwithbackpressure/solution.reference.go` for a complete
