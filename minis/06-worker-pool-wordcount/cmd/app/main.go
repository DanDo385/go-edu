...
/*
minis/06-worker-pool-wordcount: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/06-worker-pool-wordcount")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: workerpoolwordcount concepts")
		fmt.Println("See internal/workerpoolwordcount/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/workerpoolwordcount/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/workerpoolwordcount/exercise.go for implementation")
}
