...
Understanding Go slice internals and capacity growth patterns
...
2. Open the exercise file:
   ```bash
   code internal/slicesinternalscapacitygrowth/exercise.go
   ```
...
If you get stuck, check `internal/slicesinternalscapacitygrowth/solution.reference.go` for a complete
