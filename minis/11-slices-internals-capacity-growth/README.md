# 11-slices-internals-capacity-growth: Slice Internals and Capacity

## Overview

Slice Internals and Capacity exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master slice internals and capacity concepts
...
# Open internal/slices/internals/capacity/growth/exercise.go and complete the TODOs
...
See `internal/slices/internals/capacity/growth/solution.reference.go` for:
