...
//
// To use:
// 1. Set breakpoints in ../../internal/exercise/slicesinternalscapacitygrowth.go
...
import (
	...
	"github.com/example/go-10x-minis/minis/11-slices-internals-capacity-growth/internal/slicesinternalscapacitygrowth"
)
...
func main() {
	...
	// Set breakpoint in slicesinternalscapacitygrowth.go at GrowSlice function
	newSlice, oldCap, newCap := slicesinternalscapacitygrowth.GrowSlice(s, elem)
