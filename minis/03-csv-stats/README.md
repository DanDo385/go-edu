# 03-csv-stats: CSV Parsing and Statistics

## Overview

CSV Parsing and Statistics exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master csv parsing and statistics concepts
...
# Open internal/csv/stats/exercise.go and complete the TODOs
...
See `internal/csv/stats/solution.reference.go` for:
