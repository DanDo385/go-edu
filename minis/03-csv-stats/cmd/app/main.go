...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/03-csv-stats")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: csvstats concepts")
		fmt.Println("See internal/csvstats/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/csvstats/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/csvstats/exercise.go for implementation")
}
