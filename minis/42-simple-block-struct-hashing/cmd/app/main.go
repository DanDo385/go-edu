...
/*
42-simple-block-struct-hashing CLI Application
...
Quick start:
  1. Implement functions in internal/simpleblockstructhashing/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 42-simple-block-struct-hashing ===")
	fmt.Println()
