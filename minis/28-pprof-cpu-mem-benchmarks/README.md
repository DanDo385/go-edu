# 28-pprof-cpu-mem-benchmarks: Profiling and Benchmarking

## Overview

Profiling and Benchmarking exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master profiling and benchmarking concepts
...
# Open internal/pprof/cpu/mem/benchmarks/exercise.go and complete the TODOs
...
See `internal/pprof/cpu/mem/benchmarks/solution.reference.go` for:
