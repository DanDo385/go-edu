# minis/28-pprof-cpu-mem-benchmarks
...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "FibonacciIterative" -n 10
go run ./cmd/app -fn "FibonacciMatrix" -n 10
go run ./cmd/app -fn "FibonacciMemoized" -n 10
go run ./cmd/dev
```
...
- `internal/pprofcpumembenchmarks/exercise.go`: implement the TODOs here
- `internal/pprofcpumembenchmarks/solution.reference.go`: full reference solution (tagged)
