...
/*
minis/10-grpc-telemetry-service: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/10-grpc-telemetry-service")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: grpctelemetryservice concepts")
		fmt.Println("See internal/grpctelemetryservice/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/grpctelemetryservice/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/grpctelemetryservice/exercise.go for implementation")
}
