...
/*
minis/10-grpc-telemetry-service: cmd/dev (Debug Harness)
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/10-grpc-telemetry-service: Debug Harness")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	// result := grpctelemetryservice.SomeFunction(testInput)
	// fmt.Printf("Result: %v\n", result)
