...
Build a gRPC telemetry aggregator with streaming and time windows
...
2. Open the exercise file:
   ```bash
   code internal/grpctelemetryservice/exercise.go
   ```
...
If you get stuck, check `internal/grpctelemetryservice/solution.reference.go` for a complete
