# 10-grpc-telemetry-service: gRPC Telemetry Service

## Overview

gRPC Telemetry Service exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master grpc telemetry service concepts
...
# Open internal/grpc/telemetry/service/exercise.go and complete the TODOs
...
See `internal/grpc/telemetry/service/solution.reference.go` for:
