...
Channel Fundamentals exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master channel fundamentals concepts
...
# Open internal/channels/basics/exercise.go and complete the TODOs
...
See `internal/channels/basics/solution.reference.go` for:
