...
func main() {
	...
	// Example:
	// import "minis/19-channels-basics/internal/channelsbasics"
	// 
	// input := "example"
	// result := channelsbasics.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/19-channels-basics/internal/channelsbasics\"")
