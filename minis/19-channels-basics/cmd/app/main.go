...
/*
minis/19-channels-basics: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/19-channels-basics")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: channelsbasics concepts")
		fmt.Println("See internal/channelsbasics/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/channelsbasics/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/channelsbasics/exercise.go for implementation")
}
