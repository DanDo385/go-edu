...
/*
Reference Solution - Config Loader: YAML + Environment Overrides
===============================================================

gopkg.in/yaml.v3 for YAML unmarshaling. os.Getenv for env overrides; regex
to expand ${VAR} or ${VAR:-default} in strings. Nested structs with yaml tags.
Load: read file, Unmarshal, then apply env substitution. Validate: required
fields, port ranges.
*/
