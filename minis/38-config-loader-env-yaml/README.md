# minis/38-config-loader-env-yaml
...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "LoadConfig" -in "Hello, 世界 👋"
go run ./cmd/dev
```
...
- `internal/configloaderenvyaml/exercise.go`: implement the TODOs here
- `internal/configloaderenvyaml/solution.reference.go`: full reference solution (tagged)
