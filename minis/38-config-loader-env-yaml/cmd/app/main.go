...
/*
minis/38-config-loader-env-yaml: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/38-config-loader-env-yaml")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: configloaderenvyaml concepts")
		fmt.Println("See internal/configloaderenvyaml/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/configloaderenvyaml/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/configloaderenvyaml/exercise.go for implementation")
}
