...
/*
Reference Solution - Proof of Work Mining Demo
==============================================

Block hash from index, timestamp, data, prevHash, nonce. Valid proof: hash
starts with N zeros (difficulty). Mine: increment nonce until valid. Mining
is CPU-bound; demonstrates blockchain consensus. Bitcoin uses SHA-256 double-hash.
*/
