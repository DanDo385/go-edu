...
/*
minis/43-proof-of-work-demo: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/43-proof-of-work-demo")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: proofofworkdemo concepts")
		fmt.Println("See internal/proofofworkdemo/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/proofofworkdemo/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/proofofworkdemo/exercise.go for implementation")
}
