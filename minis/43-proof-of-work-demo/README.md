...
- `internal/proofofworkdemo/exercise.go`: implement the TODOs here
- `internal/proofofworkdemo/solution.reference.go`: full reference solution (tagged)
