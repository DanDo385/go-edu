# 46-generics-map-reduce: Generic Map and Reduce

## Overview

Generic Map and Reduce exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master generic map and reduce concepts
...
# Open internal/generics/map/reduce/exercise.go and complete the TODOs
...
See `internal/generics/map/reduce/solution.reference.go` for:
