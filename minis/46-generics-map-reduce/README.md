...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "NewStack"
go run ./cmd/app -fn "None"
go run ./cmd/dev
```
...
- `internal/genericsmapreduce/exercise.go`: implement the TODOs here
- `internal/genericsmapreduce/solution.reference.go`: full reference solution (tagged)
