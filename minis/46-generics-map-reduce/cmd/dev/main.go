...
func main() {
	...
	// Example:
	// import "minis/46-generics-map-reduce/internal/genericsmapreduce"
	// 
	// input := "example"
	// result := genericsmapreduce.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/46-generics-map-reduce/internal/genericsmapreduce\"")
