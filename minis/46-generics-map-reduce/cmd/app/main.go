...
/*
minis/46-generics-map-reduce: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/46-generics-map-reduce")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: genericsmapreduce concepts")
		fmt.Println("See internal/genericsmapreduce/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/genericsmapreduce/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/genericsmapreduce/exercise.go for implementation")
}
