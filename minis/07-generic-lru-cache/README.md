# 07-generic-lru-cache: Generic LRU Cache

## Overview

Generic LRU Cache exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master generic lru cache concepts
...
# Open internal/generic/lru/cache/exercise.go and complete the TODOs
...
See `internal/generic/lru/cache/solution.reference.go` for:
