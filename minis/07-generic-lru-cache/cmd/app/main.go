...
/*
minis/07-generic-lru-cache: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/07-generic-lru-cache")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: genericlrucache concepts")
		fmt.Println("See internal/genericlrucache/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/genericlrucache/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/genericlrucache/exercise.go for implementation")
}
