...
USAGE:
    ...
    go run ./cmd/app/main.go 5 5s
    go run ./cmd/app/main.go 10 10s eviction
    go run ./cmd/app/main.go 2 1s expiration

Arguments:
    [capacity] - Maximum number of items in cache (default: 3)
    [ttl]      - Time-to-live, e.g., "2s", "5m" (default: "2s")
    [demo]     - Demo to run: all, eviction, expiration (default: "all")
