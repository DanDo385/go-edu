...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "NewSolutionCache"
go run ./cmd/app -fn "NewSolutionEventBus"
go run ./cmd/app -fn "NewSolutionWorkerPool" -n 10
go run ./cmd/dev
```
...
- `internal/miniserviceallfeatures/exercise.go`: implement the TODOs here
- `internal/miniserviceallfeatures/solution.reference.go`: full reference solution (tagged)
