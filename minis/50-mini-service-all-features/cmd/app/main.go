...
/*
50-mini-service-all-features CLI Application
...
Quick start:
  1. Implement functions in internal/miniserviceallfeatures/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 50-mini-service-all-features ===")
	fmt.Println()
