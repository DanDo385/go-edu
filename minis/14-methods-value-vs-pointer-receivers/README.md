...
Understanding method receivers in Go (value vs pointer)
...
├── internal/
│   └── methodsvaluevspointerreceivers/
...
2. Open the exercise file:
   ```bash
   code internal/methodsvaluevspointerreceivers/exercise.go
   ```
...
If you get stuck, check `internal/methodsvaluevspointerreceivers/solution.reference.go` for a complete
