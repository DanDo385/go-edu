# 14-methods-value-vs-pointer-receivers: Methods and Receivers

## Overview

Methods and Receivers exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master methods and receivers concepts
...
# Open internal/methods/value/vs/pointer/receivers/exercise.go and complete the TODOs
...
See `internal/methods/value/vs/pointer/receivers/solution.reference.go` for:
