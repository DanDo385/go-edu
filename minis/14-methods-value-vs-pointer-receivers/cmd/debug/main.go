...
import (
	...
	"github.com/example/go-10x-minis/minis/14-methods-value-vs-pointer-receivers/internal/exercise"
)
...
func main() {
	...
	shapes := []exercise.Shape{
		&exercise.Rectangle{Width: 5, Height: 3},
		&exercise.Circle{Radius: 2},
	}

	fmt.Printf("Shapes: %+v\n", shapes)

	// Set breakpoint in exercise.go at TotalArea function
	total := exercise.TotalArea(shapes)
	fmt.Printf("Total area: %.2f\n", total)

	// Test SafeCounterMap
	counter := exercise.NewSafeCounterMap()
	counter.Inc("test")
