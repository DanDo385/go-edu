...
/*
14-methods-value-vs-pointer-receivers CLI Application
...
Quick start:
  1. Implement functions in internal/methodsvaluevspointerreceivers/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 14-methods-value-vs-pointer-receivers ===")
	fmt.Println()
