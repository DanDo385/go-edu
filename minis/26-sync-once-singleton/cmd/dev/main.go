...
func main() {
	...
	// Example:
	// import "minis/26-sync-once-singleton/internal/synconcesingleton"
	// 
	// input := "example"
	// result := synconcesingleton.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/26-sync-once-singleton/internal/synconcesingleton\"")
