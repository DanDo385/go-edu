...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "GetCache"
go run ./cmd/app -fn "GetConfig"
go run ./cmd/app -fn "GetDatabase" -in "Hello, 世界 👋"
go run ./cmd/dev
```
...
- `internal/synconcesingleton/exercise.go`: implement the TODOs here
- `internal/synconcesingleton/solution.reference.go`: full reference solution (tagged)
