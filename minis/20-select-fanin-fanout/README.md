# 20-select-fanin-fanout: Select and Fan Patterns

## Overview

Select and Fan Patterns exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master select and fan patterns concepts
...
# Open internal/select/fanin/fanout/exercise.go and complete the TODOs
...
See `internal/select/fanin/fanout/solution.reference.go` for:
