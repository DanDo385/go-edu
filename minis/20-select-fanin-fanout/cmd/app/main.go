...
/*
minis/20-select-fanin-fanout: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/20-select-fanin-fanout")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: selectfaninfanout concepts")
		fmt.Println("See internal/selectfaninfanout/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/selectfaninfanout/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/selectfaninfanout/exercise.go for implementation")
}
