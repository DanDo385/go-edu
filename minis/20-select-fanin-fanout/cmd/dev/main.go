...
func main() {
	...
	// Example:
	// import "minis/20-select-fanin-fanout/internal/selectfaninfanout"
	// 
	// input := "example"
	// result := selectfaninfanout.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/20-select-fanin-fanout/internal/selectfaninfanout\"")
