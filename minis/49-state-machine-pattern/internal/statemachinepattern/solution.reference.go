...
/*
Reference Solution - State Machine Pattern
==========================================

State machine: current state, transitions (fromState, event -> toState).
Transition table: map or slice of rules. Process(event): lookup transition,
validate, update state. Used for workflows, parsers, protocol handlers.
*/
