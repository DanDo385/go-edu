...
func main() {
	...
	// Example:
	// import "minis/49-state-machine-pattern/internal/statemachinepattern"
	// 
	// input := "example"
	// result := statemachinepattern.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/49-state-machine-pattern/internal/statemachinepattern\"")
