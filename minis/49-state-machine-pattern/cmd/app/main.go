...
/*
minis/49-state-machine-pattern: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/49-state-machine-pattern")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: statemachinepattern concepts")
		fmt.Println("See internal/statemachinepattern/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/statemachinepattern/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/statemachinepattern/exercise.go for implementation")
}
