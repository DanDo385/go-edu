# 49-state-machine-pattern: State Machine Pattern

## Overview

State Machine Pattern exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master state machine pattern concepts
...
# Open internal/state/machine/pattern/exercise.go and complete the TODOs
...
See `internal/state/machine/pattern/solution.reference.go` for:
