...
Implement a production-grade rate limiter using the token bucket algorithm
...
2. Open the exercise file:
   ```bash
   code internal/ratelimitertokenbucket/exercise.go
   ```
...
If you get stuck, check `internal/ratelimitertokenbucket/solution.reference.go` for a complete
