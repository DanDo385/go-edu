# 34-rate-limiter-token-bucket: Token Bucket Rate Limiter

## Overview

Token Bucket Rate Limiter exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master token bucket rate limiter concepts
...
# Open internal/rate/limiter/token/bucket/exercise.go and complete the TODOs
...
See `internal/rate/limiter/token/bucket/solution.reference.go` for:
