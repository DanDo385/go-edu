...
/*
34-rate-limiter-token-bucket CLI Application
...
Quick start:
  1. Implement functions in internal/ratelimitertokenbucket/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 34-rate-limiter-token-bucket ===")
	fmt.Println()
