...
go run ./cmd/app -fn "NewWorkerPool" -n 10
go run ./cmd/dev
```
...
- `internal/goroutines1mdemo/exercise.go`: implement the TODOs here
- `internal/goroutines1mdemo/solution.reference.go`: full reference solution (tagged)
