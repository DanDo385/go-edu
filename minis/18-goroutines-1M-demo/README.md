...
Goroutine Scaling exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master goroutine scaling concepts
...
# Open internal/goroutines/1M/demo/exercise.go and complete the TODOs
...
See `internal/goroutines/1M/demo/solution.reference.go` for:
