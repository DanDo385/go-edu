...
- The concrete problem in Goroutines 1M Demo and the correctness invariants it depends on.
...
- Diagnose and implement Goroutines 1M Demo patterns without relying on hidden framework behavior.
...
Problem statement:
This lesson turns the previous module's concepts into a reusable engineering pattern for goroutines 1M demo.

At this point in the arc:
Lesson 18 introduces a sharper systems concern so later modules can assume this mental model is stable.
...
## Related Lessons
- Previous: `minis/17-file-streaming-bufio`
- Next: `minis/19-channels-basics`
