...
/*
minis/18-goroutines-1M-demo: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/18-goroutines-1M-demo")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: goroutines1mdemo concepts")
		fmt.Println("See internal/goroutines1mdemo/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/goroutines1mdemo/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/goroutines1mdemo/exercise.go for implementation")
}
