...
/*
Reference Solution - Plugin System with Hot Reload
==================================================

plugin package: Open .so, Lookup symbol. Plugin interface for Load/Unload.
Hot reload: watch dir, rebuild plugin, swap. Mutex for thread-safe plugin
access. Plugin.New() returns interface; each plugin implements common interface.
*/
