# 47-plugin-system-hot-reload: Plugin System

## Overview

Plugin System exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master plugin system concepts
...
# Open internal/plugin/system/hot/reload/exercise.go and complete the TODOs
...
See `internal/plugin/system/hot/reload/solution.reference.go` for:
