...
- The concrete problem in Caching Reverse Proxy and the correctness invariants it depends on.
...
- Diagnose and implement Caching Reverse Proxy patterns without relying on hidden framework behavior.
...
Problem statement:
This lesson turns the previous module's concepts into a reusable engineering pattern for caching reverse proxy.

At this point in the arc:
Lesson 36 introduces a sharper systems concern so later modules can assume this mental model is stable.
...
This module teaches you how to build a caching reverse proxy.
...
- **httputil.ReverseProxy**: Standard library proxy
...
## Related Lessons
- Previous: `minis/35-jwt-auth-middleware`
- Next: `minis/37-http-middleware-chain`
