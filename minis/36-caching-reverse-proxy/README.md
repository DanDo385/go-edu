...
Build a caching reverse proxy to reduce backend load and improve response times
...
2. Open the exercise file:
   ```bash
   code internal/cachingreverseproxy/exercise.go
   ```
...
If you get stuck, check `internal/cachingreverseproxy/solution.reference.go` for a complete
