# 36-caching-reverse-proxy: Caching Reverse Proxy

## Overview

Caching Reverse Proxy exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master caching reverse proxy concepts
...
# Open internal/caching/reverse/proxy/exercise.go and complete the TODOs
...
See `internal/caching/reverse/proxy/solution.reference.go` for:
