...
/*
minis/36-caching-reverse-proxy: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/36-caching-reverse-proxy")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: cachingreverseproxy concepts")
		fmt.Println("See internal/cachingreverseproxy/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/cachingreverseproxy/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/cachingreverseproxy/exercise.go for implementation")
}
