...
/*
minis/33-tcp-echo-server-client: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/33-tcp-echo-server-client")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: tcpechoserverclient concepts")
		fmt.Println("See internal/tcpechoserverclient/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/tcpechoserverclient/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/tcpechoserverclient/exercise.go for implementation")
}
