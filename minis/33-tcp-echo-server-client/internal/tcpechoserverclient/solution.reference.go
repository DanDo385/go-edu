...
/*
Reference Solution - TCP Echo Server and Client
==============================================

net.Listen("tcp", addr), Accept(), one goroutine per connection. bufio.Scanner
for line-by-line read; bufio.Writer for buffered write. net.Dial for client.
Flush after writes. handleClient defers conn.Close(). Demonstrates raw TCP
vs HTTP: no request/response framing, just stream of bytes.
*/
