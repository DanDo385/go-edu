...
Digital Signatures exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master digital signatures concepts
...
# Open internal/signed/transactions/ed25519/exercise.go and complete the TODOs
...
See `internal/signed/transactions/ed25519/solution.reference.go` for:
