...
2. Open the exercise file:
   ```bash
   code internal/signedtransactionsed25519/exercise.go
   ```
...
If you get stuck, check `internal/signedtransactionsed25519/solution.reference.go` for a complete
