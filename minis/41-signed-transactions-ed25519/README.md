# minis/41-signed-transactions-ed25519
...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "GenerateWallet"
go run ./cmd/dev
```
...
- `internal/signedtransactionsed25519/exercise.go`: implement the TODOs here
- `internal/signedtransactionsed25519/solution.reference.go`: full reference solution (tagged)
