...
/*
Reference Solution - Ed25519 Signed Transactions
================================================

crypto/ed25519: GenerateKey, Sign, Verify. Wallet: keypair + address (from
pubkey). SignTransaction: canonical JSON, sign digest. VerifyTransaction:
recover pubkey from signature or use stored pubkey, ed25519.Verify. Hex
encoding for storage/transport.
*/
