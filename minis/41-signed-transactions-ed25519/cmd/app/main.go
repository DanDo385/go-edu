...
/*
41-signed-transactions-ed25519 CLI Application
...
Quick start:
  1. Implement functions in internal/signedtransactionsed25519/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 41-signed-transactions-ed25519 ===")
	fmt.Println()
