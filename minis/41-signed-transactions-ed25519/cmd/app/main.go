...
/*
minis/41-signed-transactions-ed25519: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/41-signed-transactions-ed25519")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: signedtransactionsed25519 concepts")
		fmt.Println("See internal/signedtransactionsed25519/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/signedtransactionsed25519/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/signedtransactionsed25519/exercise.go for implementation")
}
