...
/*
minis/44-mempool-in-memory: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/44-mempool-in-memory")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: mempoolinmemory concepts")
		fmt.Println("See internal/mempoolinmemory/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/mempoolinmemory/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/mempoolinmemory/exercise.go for implementation")
}
