...
func main() {
	...
	// Example:
	// import "minis/44-mempool-in-memory/internal/mempoolinmemory"
	// 
	// input := "example"
	// result := mempoolinmemory.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/44-mempool-in-memory/internal/mempoolinmemory\"")
