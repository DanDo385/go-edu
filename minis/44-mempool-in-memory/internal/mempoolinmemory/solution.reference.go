...
/*
Reference Solution - In-Memory Mempool (Transaction Pool)
=========================================================

Mempool: pending transactions before inclusion in a block. Add, Remove,
GetByHash, GetAll. Ordered by fee/priority or FIFO. Thread-safe with mutex.
Eviction when full (lowest fee first). Simulates blockchain node's pending tx buffer.
*/
