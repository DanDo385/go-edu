...
```bash
go run ./cmd/app -list
go run ./cmd/app -fn "NewFIFOMempool" -n 10
go run ./cmd/app -fn "NewNonceMempool"
go run ./cmd/app -fn "NewPriorityMempool" -n 10
go run ./cmd/dev
```
...
- `internal/mempoolinmemory/exercise.go`: implement the TODOs here
- `internal/mempoolinmemory/solution.reference.go`: full reference solution (tagged)
