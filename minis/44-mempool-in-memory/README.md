# 44-mempool-in-memory: In-Memory Mempool

## Overview

In-Memory Mempool exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master in-memory mempool concepts
...
# Open internal/mempool/in/memory/exercise.go and complete the TODOs
...
See `internal/mempool/in/memory/solution.reference.go` for:
