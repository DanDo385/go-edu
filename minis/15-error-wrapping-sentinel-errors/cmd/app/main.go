...
/*
15-error-wrapping-sentinel-errors CLI Application
...
Quick start:
  1. Implement functions in internal/errorwrappingsentinelerrors/exercise.go
  2. Run tests: go test -v ./...
  3. Use this CLI to test your implementation
*/
func main() {
	fmt.Println("=== 15-error-wrapping-sentinel-errors ===")
	fmt.Println()
