...
/*
minis/15-error-wrapping-sentinel-errors: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/15-error-wrapping-sentinel-errors")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: errorwrappingsentinelerrors concepts")
		fmt.Println("See internal/errorwrappingsentinelerrors/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/errorwrappingsentinelerrors/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/errorwrappingsentinelerrors/exercise.go for implementation")
}
