...
2. Open the exercise file:
   ```bash
   code internal/errorwrappingsentinelerrors/exercise.go
   ```
...
If you get stuck, check `internal/errorwrappingsentinelerrors/solution.reference.go` for a complete
