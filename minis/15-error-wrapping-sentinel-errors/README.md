...
Error Handling Patterns exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master error handling patterns concepts
...
# Open internal/error/wrapping/sentinel/errors/exercise.go and complete the TODOs
...
See `internal/error/wrapping/sentinel/errors/solution.reference.go` for:
