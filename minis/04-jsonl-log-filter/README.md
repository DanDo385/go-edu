# 04-jsonl-log-filter: JSON Lines Log Filtering

## Overview

JSON Lines Log Filtering exercise focusing on practical Go programming patterns.

## Learning Objectives

- Master json lines log filtering concepts
...
# Open internal/jsonl/log/filter/exercise.go and complete the TODOs
...
See `internal/jsonl/log/filter/solution.reference.go` for:
