...
func main() {
	...
	// Example:
	// import "minis/04-jsonl-log-filter/internal/jsonllogfilter"
	// 
	// input := "example"
	// result := jsonllogfilter.YourFunction(input)
	// fmt.Printf("Result: %v\n", result)
	
	fmt.Println("To use this debug harness:")
	fmt.Println("1. Import the module: import \"minis/04-jsonl-log-filter/internal/jsonllogfilter\"")
