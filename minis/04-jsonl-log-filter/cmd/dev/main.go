...
//
// To use:
// 1. Set breakpoints in ../../internal/exercise/jsonllogfilter.go
...
{"level":"warn","message":"Warning message"}`
	...
	// Set breakpoint in jsonllogfilter.go at FilterLogs function
	entries, err := jsonllogfilter.FilterLogs(reader, level)
	if err != nil {
		fmt.Printf("Error: %v\n", err)
		return
	}
