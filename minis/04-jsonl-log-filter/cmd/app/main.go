...
/*
minis/04-jsonl-log-filter: cmd/app
...
func main() {
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  minis/04-jsonl-log-filter")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	if len(os.Args) < 2 {
		...
		fmt.Println()
		fmt.Println("This module demonstrates: jsonllogfilter concepts")
		fmt.Println("See internal/jsonllogfilter/ for implementation details")
		os.Exit(1)
	}
	...
	// Import and call functions from internal/jsonllogfilter/exercise.go
	
	fmt.Println("✓ Complete")
	fmt.Println()
	fmt.Println("See internal/jsonllogfilter/exercise.go for implementation")
}
