# 23: Pending Transaction Visibility

## Core Concepts

- Problem framing for Pending Transaction Visibility: what state we need, what invariants we must keep.
...
This closes core runtime observability before full monitoring.

Problem statement:
Read pending tx counts and optional display limits.
...
Counts are values, but wrapper structs can still be aliased; keep immutable result snapshots.
