# 12: Account/Storage Proof Retrieval

## Core Concepts

- Problem framing for Account/Storage Proof Retrieval: what state we need, what invariants we must keep.
...
After storage reads, learners verify state cryptographically.

Problem statement:
Fetch trie proofs and normalize account/storage proof payloads.
...
Proof values are pointer-heavy (`*big.Int`, slices of nodes); deep-copy to prevent aliasing across callers.
