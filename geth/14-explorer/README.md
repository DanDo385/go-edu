# 14: Explorer Block Views

## Core Concepts

- Problem framing for Explorer Block Views: what state we need, what invariants we must keep.
...
This combines earlier read APIs into a user-facing representation.

Problem statement:
Assemble block/tx summaries suitable for explorer-style output.
...
`tx.To()` returns `*common.Address`; copy pointed values before persisting summaries.
