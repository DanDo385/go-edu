...
- **`-number`**: `Config.Number` (*big.Int)
- **`-include-txs`**: `Config.IncludeTxs` (bool)
...
- `internal/explorer/exercise.go`: implement the TODOs here
- `internal/explorer/solution.reference.go`: full reference solution (tagged)
