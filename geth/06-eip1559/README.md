...
Build and sign an EIP-1559 dynamic fee transaction with proper fee estimation.
...
2. Open the exercise file:
   ```bash
   code internal/eip1559/exercise.go
   ```
...
If you get stuck, check `internal/eip1559/solution.reference.go` for a complete
