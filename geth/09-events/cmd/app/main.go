...
/*
Events and Logs Demo

This application demonstrates querying and decoding Ethereum events/logs.
Events are how contracts communicate state changes to external observers.
