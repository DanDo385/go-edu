...
- **`-output-dir`**: `Config.OutputDir` (string)
- **`-passphrase`**: `Config.Passphrase` (string)
...
- `internal/keysaddresses/exercise.go`: implement the TODOs here
- `internal/keysaddresses/solution.reference.go`: full reference solution (tagged)
