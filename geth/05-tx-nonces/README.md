...
- **`-gas-price`**: `Config.GasPrice` (*big.Int)
...
- `internal/txnonces/exercise.go`: implement the TODOs here
- `internal/txnonces/solution.reference.go`: full reference solution (tagged)
