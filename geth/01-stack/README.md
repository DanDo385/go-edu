...
Prove RPC connectivity by reading the network identifiers and latest header.
...
2. Open the exercise file:
   ```bash
   code internal/stack/exercise.go
   ```
...
If you get stuck, check `internal/stack/solution.reference.go` for a complete
