...
- **`-addresses`**: `Config.Addresses` ([]common.Address)
...
```bash
go run ./cmd/app -rpc "https://eth.llamarpc.com" -addresses "0xd8dA6BF26964aF9D7eEd9e03E53415D37aA96045"
go run ./cmd/dev
```
...
- `internal/accountsbalances/exercise.go`: implement the TODOs here
- `internal/accountsbalances/solution.reference.go`: full reference solution (tagged)
