...
Build a Swiss Army knife CLI that combines multiple node operations.
...
2. Open the exercise file:
   ```bash
   code internal/toolbox/exercise.go
   ```
...
If you get stuck, check `internal/toolbox/solution.reference.go` for a complete
